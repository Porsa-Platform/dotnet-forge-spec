...
This document specifies `scripts/gherkin-ir-dry-checker.cs`, the primary
portable report-only script that reads one parser-produced JSON IR file and
reports repeated, near-duplicated, and possible-synonym step text. The script
uses .NET 10 file-based app capabilities.
