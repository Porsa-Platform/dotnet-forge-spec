...
This document specifies `scripts/gherkin-parser.cs`, the primary portable
script that converts a small deterministic Gherkin subset into the JSON
intermediate representation used by the acceptance generator, runtime, and
mutator. The script uses .NET 10 file-based app capabilities.
